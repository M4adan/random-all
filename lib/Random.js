...
let Weighted = require("./WeightedRandom.js");
let Unique = require("./UniqueRandom.js");
...
Random.prototype.new = function (){
    return new Random();
}

Random.prototype.getClass = function (){
    return Random;
}

Random.prototype.createObject = function (){
    return new Random()
}
